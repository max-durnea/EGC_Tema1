...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
			...
			VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 1, 5), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 1, 7), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 20, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2,0.8,0.6)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 18, 1), glm::vec3(0.2,0.8,0.6)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 120, 1), glm::vec3(0.2,0.8,0.6)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(6, 1, 1), glm::vec3(0.2,0.8,0.6)) 
        };
        ...
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 5), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 7), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 20, 1), glm::vec3(0.2,0.8,0.6))
        };
        ...
        vector<VertexFormat> tetrahedronVertices
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 5), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 7), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 1,  0.5), glm::vec3(0, 20, 1), glm::vec3(0.2,0.8,0.6))
        };
        ...
        // Create Ramp mesh
        vector<VertexFormat> rampVertices{
            VertexFormat(glm::vec3(0,0,0), glm::vec3(1, 0, 0), glm::vec3(1,0,0)),
            VertexFormat(glm::vec3(0,0,1), glm::vec3(1, 0, 0), glm::vec3(1,0,0)),
            VertexFormat(glm::vec3(1,0,1), glm::vec3(0, 0, 0), glm::vec3(0,0,0)),
            VertexFormat(glm::vec3(1,0,0), glm::vec3(0, 0, 0), glm::vec3(0,0,0)),
            VertexFormat(glm::vec3(0,1,1), glm::vec3(1, 0, 0), glm::vec3(1,0,0)),
            VertexFormat(glm::vec3(0,1,0), glm::vec3(1, 0, 0), glm::vec3(1,0,0))
        };
        vector<unsigned int> rampIndices{
            0,1,4,
			0,4,5,
			1,2,4,
			2,3,5,
        ...
        vector<VertexFormat>pacman{
            VertexFormat(glm::vec3(0,0,0), glm::vec3(1, 0, 0), glm::vec3(1,0,0)),
            VertexFormat(glm::vec3(0,1,0), glm::vec3(1, 0, 0), glm::vec3(1,0,0)),
            VertexFormat(glm::vec3(-1,0,0), glm::vec3(0, 0, 0), glm::vec3(0,0,0)),
            VertexFormat(glm::vec3(0,-1,0), glm::vec3(0, 0, 0), glm::vec3(0,0,0)),
            VertexFormat(glm::vec3(1,0,0), glm::vec3(0, 0, 0), glm::vec3(0,0,0))
        };

        vector<unsigned int>pacmanI{
            0,1,2,
            2,3,0,
            0,3,4,
		...
		CreateMesh("ramp", rampVertices, rampIndices);
		CreateMesh("pacman", pacman, pacmanI);
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(2.0f));
    // TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(2.0f));
	// Ramp
	RenderMesh(meshes["ramp"], shaders["VertexNormal"], glm::vec3(2.5f, 0.5f, 5), glm::vec3(1.0f));
    // TODO(student): Disable face culling
	glDisable(GL_CULL_FACE);
    // Draw the pacman
	RenderMesh(meshes["pacman"], shaders["VertexColor"], glm::vec3(5.0f, 0.5f, 2), glm::vec3(2.0f));
